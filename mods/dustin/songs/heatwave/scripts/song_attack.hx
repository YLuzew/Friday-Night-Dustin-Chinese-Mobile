...
function stepHit(step:Int) {
    ...
    switch (step) {
        ...
        case 4: 
            ...
            executeEvent({name: "Lyrics", time: 0, params: ["Add Text", "做好保护灵魂的准备。", 0xFFFFFFFF, false]});
        ...
        case 62:
            ...
            executeEvent({name: "Lyrics", time: 0, params: ["Set Color", "按下 Z 射击", 0xFFFFFF00, false]});
            executeEvent({name: "Lyrics", time: 0, params: ["Add Text", "按下 Z 射击", 0xFFFFFF00, false]});
        case 63:
            arrowKeyIndicator.visible = false;
