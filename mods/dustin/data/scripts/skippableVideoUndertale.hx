...
function startVideo(name:String, ?leCallback:Void->Void, ?ext:String, ?usePath:Bool) {
    ...
    add(skipText = new FunkinText(-28, FlxG.height - 50 - 6, FlxG.width, "按住 屏幕任意处 以跳过...").setFormat(Paths.font('8bit-jve.ttf'), 32, 0xffffffff, "right", FlxTextBorderStyle.OUTLINE, 0xff000000));
