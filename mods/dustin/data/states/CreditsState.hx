...
function create() {
    ...
    shText = new FlxText(0, 500, 500, "按 A 键\n聆听回音", 40, true);
...
function update(elapsed:Float) {
    ...
    if ((FlxG.keys.justPressed.SPACE || touchPad.buttonC.justPressed) && lineTextObj.isTyping) {
    ...
    if (infoVisible) {
        ...
        } else if (imageDisplay.alpha > 0 && (controls.LEFT || controls.RIGHT)) {
